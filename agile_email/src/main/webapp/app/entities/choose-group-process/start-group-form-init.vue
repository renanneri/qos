    ...
    <div class="col-10">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div v-if="chooseGroupProcess.processInstance">
          <akip-show-process-definition :processDefinition="chooseGroupProcess.processInstance.processDefinition">
              ...
              <div v-if="chooseGroupProcess.group">
                <div class="form-group">
                  ...
                  <input
                    ...
                    data-cy="GroupName"
                    :class="{
                      valid: !$v.chooseGroupProcess.group.GroupName.$invalid,
                      invalid: $v.chooseGroupProcess.group.GroupName.$invalid,
                    }"
                    v-model="$v.chooseGroupProcess.group.GroupName.$model"
                  />
                </div>
              </div>
            </template>
          ...
          <button
            ...
            :disabled="$v.chooseGroupProcess.$invalid || isSaving"
